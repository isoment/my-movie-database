...
@section('content')
    <div class="container mx-auto px-9 my-8">
        <div>
            ...
            <div class="text-sm font-semibold tracking-wide leading-snug mt-4">
                This product uses the TMDb API but is not endorsed or certified by TMDb.<br>
                <a href="https://www.themoviedb.org/" class="text-primary-blue-dark">The Movie Database</a><br>
                <a href="https://developers.themoviedb.org/3" class="text-primary-blue-dark">TMDB API Documentation</a>
            </div>
        </div>
    </div>
@endsection